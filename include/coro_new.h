...
typedef boost::coroutines::asymmetric_coroutine<Handler>::push_type PushCoroutine;
typedef boost::coroutines::asymmetric_coroutine<Handler>::pull_type PullCoroutine;
